...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{BAstem/fig_ch3/手势运动方向检测流程图.png}
  \caption{手势运动方向检测流程图}
...
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.48\textwidth}
        \centering
        \includegraphics[height=0.2\textheight]{BAstem/fig_ch3/粗粉_涂层在冷却过程中残余热应力的变化情况.png}
        \subcaption{粗粉涂层}
    \end{minipage}
    \begin{minipage}[c]{0.48\textwidth}
        \centering
        \includegraphics[height=0.2\textheight]{BAstem/fig_ch3/细粉_涂层在冷却过程中残余热应力的变化情况.png}
        \subcaption{细粉涂层}
    \end{minipage}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{BAstem/fig_ch3/透平膨胀机的组成结构.png}
  \caption{透平膨胀机的组成结构}
