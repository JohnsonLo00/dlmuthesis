...
\begin{personalcv}{作者简历及攻读博士学位期间的科研成果}[addtotoc]
...
首先，列出在攻读博士学位期间发表与学位论文有关的学术论文（含已录用），并注明属于学位论文内容的部分（章节），作者（最多三个）、论文题目、刊物名称、时间、卷期号、页码以及检索信息、与学位论文相关章节。{\bfseries\itshape 在攻读博士学位期间以外的时间或与学位论文内容(章节)无关的论文不得列出。}

其次，列出在攻读博士学位期间参加学术会议发表的会议论文，参与的科研项目（如国家自然科学基金或国家“863”计划等），发明专利、科研奖励等。
...
4. 发明专利
\begin{enumerate}[nosep, label=$\lbrack$\arabic*$\rbrack$]
  \item{\underline{\bf 张晓明}，发明人2，发明人3. 多功能一次性压舌板:中国,92214985.2[P]. 发明类别：发明专利，公开（或授权）日期：1993,04,14。} %对自身名字加黑加下划线
\end{enumerate}{}\vspace{1em}
