...
% ---------- 声明文档类 ---------- %
\documentclass[DOCmarxism,windows]{dlmuthesis}
% 有如下类型的可选参数：
...
\begin{abstract}
\input{mainbody/DOCmarxism/abstract_innovation}
\end{abstract}%
...
\begin{abstract}
\input{mainbody/DOCmarxism/abstract_zh}
\end{abstract}%
\nextpages{abstractCN}
% =================================== %	
...
\begin{abstract}
\input{mainbody/DOCmarxism/abstract_en}
\end{abstract}%
\nextpages{abstractEN}
% =================================== %	
...
% -------------------- 目录 -------------------- %
\presetupOFtocs%
\tableofcontents\aftertoc %若全文一个图表都没有，则把 \aftertoc 命令注释掉
...
\input{mainbody/DOCmarxism/ch1} \clearpage
\input{mainbody/DOCmarxism/ch2} \clearpage
\input{mainbody/DOCmarxism/ch3} \clearpage
\input{mainbody/DOCmarxism/conclusion} \clearpage % 结论
% ================================================== %
...
\input{refs/refs_DOCmarxism} %当文献数量较多时，也可通过单独的tex文件进行导入
\end{thebibliography}
}
\clearpage
% ============================== %
...
% ---------- 附录 ---------- %
\begin{appendices}
\input{mainbody/DOCmarxism/appendices}
\end{appendices}
\clearpage
% ========================= %
...
% ----- 科研成果 ----- %
\input{mainbody/DOCmarxism/authorachievements}
\clearpage
% =================================== %	


% ---------- 致谢 ---------- %
\input{mainbody/DOCmarxism/acknowledgment}
\clearpage
% ============================== %


% ----- 作者简介 ----- %
\input{mainbody/DOCmarxism/authorintroduction}
