...
% ---------- 正文（划分为多个独立文件依次导入） ---------- %
\pesudohook
\input{mainbody/BAhumanities/ch1} \clearpage\vspace*{0pt} %\vspace*{0pt}的添加解决了章节标题前间距不合理的问题
\input{mainbody/BAhumanities/ch2} \clearpage\vspace*{0pt}
\input{mainbody/BAhumanities/ch3} \clearpage\vspace*{0pt}
\input{mainbody/BAhumanities/conclusions} \clearpage\vspace*{0pt} % 总结
% ================================================== %
...
% ---------- 致谢 ---------- %
\input{mainbody/BAhumanities/acknowledgments}
% ================================================== %
